 ...
 *********************************************************************************/
void dht11_rmt_rx_init(int gpio_pin, int channel)
{
 ...
 *********************************************************************************/
static void dump_items(rmt_item32_t* item, int item_num) {
    for (int k = 0; k < 42; k++) {
        ESP_LOGI(__FILE__, "%d:%d -> %d:%d", 
                            item[k].level0, item[k].duration0, 
                            item[k].level1, item[k].duration1);
    }
}
